...
fig.add_trace(
    go.Scatter(x=[1000, 10000, 25000, 50000], y=scoreDT, name="Accuracy Decision Tree"),
    secondary_y=False,
)

fig.add_trace(
    go.Scatter(x=[1000, 10000, 25000, 50000], y=scoreRF, name="Accuracy Random Forest"),
    secondary_y=False,
)
fig.add_trace(
    go.Scatter(x=[1000, 10000, 25000, 50000], y=scoreGB, name="Accuracy Gradient Boosting Tree"),
    secondary_y=False,
)
...
# Set y-axes titles
#fig.update_yaxes(title_text="Training Time in seconds", secondary_y=False, range=[math.floor(timeDT[0]), math.ceil(timeGB[-1])])
